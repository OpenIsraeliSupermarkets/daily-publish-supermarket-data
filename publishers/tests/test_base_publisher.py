...
from publishers.tests.validation_utils import validate_scraper_output,validate_converting_output,validate_state_after_deleted_dump_files,validate_state_after_api_update,validate_long_term_structure,validate_cleanup
...
def test_clean_all_source_data_integration():
    ...
    try:
        ...
        validate_cleanup(publisher.app_folder,publisher.data_folder,publisher.outputs_folder,publisher.status_folder)
    except Exception as e:
