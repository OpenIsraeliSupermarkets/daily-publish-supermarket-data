...
class TestTokenValidator:
    ...
    @pytest.fixture
    def token_validator(self, mock_supabase):
    ...
    def test_init(self, mock_supabase):
        ...
        with patch.dict(os.environ, {"SUPABASE_URL": "test_url", "SUPABASE_KEY": "test_key"}):
            ...
            from access.token_validator import create_client
            create_client.assert_called_once_with("test_url", "test_key")
...
class TestSupabaseTelemetry:
    ...
    @pytest.fixture
    def telemetry(self, mock_supabase):
    ...
    def test_init_missing_env_vars(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            with pytest.raises(ValueError) as excinfo:
                SupabaseTelemetry()
            assert "SUPABASE_URL and SUPABASE_KEY environment variables must be set" in str(excinfo.value)
    ...
    def test_send_telemetry_exception(self, telemetry, mock_supabase, caplog):
